...
export const proData: Project[] = [
  {
    ...
    technology: ['C#', 'SQL'],
    platform: ['github'],
    imagePath: 'assets/images/projects/pis.webp',
    description:
  ...
  },
  {
    ...
    platform: ['github'],
    imagePath: 'assets/images/projects/aas.webp',
    description:
  ...
  },
  {
    ...
    technology: ['Python'],
    platform: ['github'],
    imagePath: 'assets/images/projects/kmldata.webp',
    description:
  ...
  },
  {
    ...
    platform: ['github'],
    imagePath: 'assets/images/projects/portfolio.webp',
    description:
